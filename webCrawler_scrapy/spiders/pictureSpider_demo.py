...
class Spdier_pictures(scrapy.spiders.Spider):
    ...
    start_urls=["http://desk.zol.com.cn/meinv/1920x1080/1.html"]   #开始爬取的地址
    ...
    def parse(self, response):
        ...
        if(re.match("http://desk.zol.com.cn/meinv/\d+x\d+/\d+.html", response.url)):#如果url能够匹配到需要爬取的url，就爬取
            ...
            for url in all_urls:
                if url.startswith("/meinv/1920x1080/"):#若是满足定义的条件，继续爬取
